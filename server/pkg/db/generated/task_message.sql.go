...
RETURNING id, task_id, seq, type, tool, content, input, output, created_at, metadata
`
...
SELECT id, task_id, seq, type, tool, content, input, output, created_at, metadata FROM task_message
WHERE task_id = $1
ORDER BY seq ASC
`
